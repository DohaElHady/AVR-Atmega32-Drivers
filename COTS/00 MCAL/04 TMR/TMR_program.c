...
void		TMR1_voidInit(void)
{
			...
			CLR_BIT(TCCR1_REG,WGM10);
			CLR_BIT(TCCR1_REG,WGM11);
			CLR_BIT(TCCR1_REG,WGM12);
			CLR_BIT(TCCR1_REG,WGM13);
	#elif 	TMR1_WAVE_GEN		==	PWM_8BIT_WAVE_GEN
			SET_BIT(TCCR1_REG,WGM10);
			CLR_BIT(TCCR1_REG,WGM11);
			CLR_BIT(TCCR1_REG,WGM12);
			CLR_BIT(TCCR1_REG,WGM13);
	#elif 	TMR1_WAVE_GEN		==	PWM_9BIT_WAVE_GEN
			CLR_BIT(TCCR1_REG,WGM10);
			SET_BIT(TCCR1_REG,WGM11);
			CLR_BIT(TCCR1_REG,WGM12);
			CLR_BIT(TCCR1_REG,WGM13);
			...
			CLR_BIT(TCCR1_REG,CS10);
			CLR_BIT(TCCR1_REG,CS11);
			CLR_BIT(TCCR1_REG,CS12);
	#elif TMR1_CLK_SELECT		==	PRESCALER_0
			SET_BIT(TCCR1_REG,CS10);
			CLR_BIT(TCCR1_REG,CS11);
			CLR_BIT(TCCR1_REG,CS12);
	#elif TMR1_CLK_SELECT		==	PRESCALER_8
			CLR_BIT(TCCR1_REG,CS10);
			SET_BIT(TCCR1_REG,CS11);
			CLR_BIT(TCCR1_REG,CS12);
			...
			CLR_BIT(TCCR1_REG,COM1A0);
			CLR_BIT(TCCR1_REG,COM1A1);
	#elif TMR1A_COMPARE_MATCH		==	TOGGLE_OC_COMPARE_MATCH
			SET_BIT(TCCR1_REG,COM1A0);
			CLR_BIT(TCCR1_REG,COM1A1);
	#elif TMR1A_COMPARE_MATCH		==	CLR_OC_COMPARE_MATCH
			CLR_BIT(TCCR1_REG,COM1A0);
			SET_BIT(TCCR1_REG,COM1A1);
			...
			CLR_BIT(TCCR1_REG,COM1B0);
			CLR_BIT(TCCR1_REG,COM1B1);
	#elif TMR1B_COMPARE_MATCH		==	TOGGLE_OC_COMPARE_MATCH
			SET_BIT(TCCR1_REG,COM1B0);
			CLR_BIT(TCCR1_REG,COM1B1);
	#elif TMR1B_COMPARE_MATCH		==	CLR_OC_COMPARE_MATCH
			CLR_BIT(TCCR1_REG,COM1B0);
			SET_BIT(TCCR1_REG,COM1B1);
